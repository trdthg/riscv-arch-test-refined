...
class sail_cSim(pluginTemplate):
    ...
    def runTests(self, testList, cgf_file=None, header_file= None):
        ...
        for file in testList:
            ...
            execute += self.sail_exe[self.xlen] + ' -c /home/trdthg/repo/act/riscv-arch-test/riscof-plugins/rv32_zilsd/default.json -v --trace=step --test-signature={0} {1} > {2}.log 2>&1;'.format(sig_file, elf, test_name)
