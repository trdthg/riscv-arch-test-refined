...
class sail_cSim(pluginTemplate):
    ...
    def runTests(self, testList, cgf_file=None, header_file= None):
        ...
        for file in testList:
            ...
            execute += self.sail_exe[self.xlen] + ' --enable-zicbom --enable-zicboz --enable-zicbop -i -v --trace=step --pmp-count=16 --pmp-grain=0 --ram-size=8796093022208 --signature-granularity=8  --test-signature={0} {1} > {2}.log 2>&1;'.format(sig_file, elf, test_name)
